...
<div class="main-container flex-fill d-flex position-relative pencontainer" style="background-color: #fff">

    <div class="mainmain videoContainer d-lg-none hidden-md-up ">
        <video loop muted autoplay class="bgVideo" type="video/mp4">
            <source src="<?=base_url('assets/images/wide.mp4')?>" type="video/mp4">
        </video>
    </div>

    <div class="mainmain container2 d-none d-lg-flex">
        <video loop muted autoplay class="media2" type="video/mp4" data-object-fit="cover">
            <source src="<?=base_url('assets/images/wide.mp4')?>" type="video/mp4">
        </video>
    </div>

    <div class="thankyou flex-grow-1 pencontainer" style="min-height: 100px; display: none;">
        <div class="d-flex flex-column align-items-center h-100 w-100">
            <div class="flex-grow-1 row ">
                <div class="col-sm-12 my-auto" style="font-size: 30px;">
                    Thank You
                </div>
            </div>
        </div>
        ...
        function newTagSubmittedAnimation(strFirstName, strLastName, strMessage) {
          ...
          setTimeout(function() {
              ...
              setTimeout(function() {
                  ...
                  animation3.find('.text-author').html(escapeNull(strFirstName) + ' ' + escapeNull(strLastName));
                  animation3.textfill({
                      innerTag: '.text-inner-container',
                      maxFontPixels: 50,
                      explicitWidth: 250,
              ...
              animation3.addClass(strClass);
              setTimeout(function() {
                  animation1.removeClass(strClass);
              }, 2000);
              ...
              setTimeout(function() {
                  ...
                  animation3.removeClass(strClass);
                  jQuery(".mainmain").removeClass("d-flex");
                  jQuery(".mainmain").removeClass("d-lg-flex");
                  jQuery(".mainmain").fadeOut(500, function(){
                    jQuery(".thankyou").delay(500).fadeIn(500, function(){
                        setTimeout(function() {
