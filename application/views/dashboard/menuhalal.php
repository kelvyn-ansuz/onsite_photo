...
<div class="registration-container" style="padding-top: 0px; padding-bottom:10px;">
  <div class="mainForm container-fluid" style="max-width:700px!important; padding:10px;text-align:center;">
    ...
    <div class="row">
      <div class="col dashheader">Dinner Menu (Halal)</div>
    </div>


    <div>

    <iframe src="https://docs.google.com/viewer?url=<?=base_url('assets/images/halal.pdf')?>&embedded=true" style="width:100%; height:60vh;" frameborder="0"></iframe>
